    ...
    <v-card>
      ...
      >
        <v-toolbar-title class="px-0">
          <span class="toolbar_font_size">사업장 추가</span>
        </v-toolbar-title>
        <v-spacer />
        <v-btn
          icon
                         ...
                         <div class="d-flex justify-space-between">
                          <span class="flex-grow-1 px-2">
                            <v-text-field                
                              ...
                              @blur="$v.WorkPlaceData.WORKPLACE_ID.$touch()"                   
                            >
                            <template
                              v-slot:append
                            >
...
export default {
    ...
    computed:{
        ...
        WORKPLACE_NAME_Errors() {       //법인 관련 오류 메시지
            ...
            //!this.$v.WorkPlaceData.WORKPLACE_NAME.minLength && errors.push('사업장명이 너무 짧습니다.');                    
            return errors;
        },
    ...
    methods: {
        ...
        ShowDlg(){  //다이얼로그를 출력한다.        
          //초기화
          this.WorkPlaceData.CORPORATE_ID = '';
          this.WorkPlaceData.WORKPLACE_ID = '';
          this.WorkPlaceData.WORKPLACE_NAME = '';
          this.WorkPlaceData.ACTV = 'Y';          
