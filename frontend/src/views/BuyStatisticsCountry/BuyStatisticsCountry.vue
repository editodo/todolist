    ...
    >
      ...
      >
        <v-toolbar-title dense>
          <v-icon class="title_font_color toolbar_icon_size">bar_chart</v-icon> <span class="toolbar_font_size">지역별 구매집계</span>
        </v-toolbar-title>
        <v-spacer />            
        <!--필요시 여기에 버튼을 넣는다. -->
      </v-toolbar>
                ...
                <v-toolbar       
                  ...
                  >
                    <v-toolbar-title dense>
                      ...
                      <span class="toolbar_font_size">지역별 구매 금액</span>
                    </v-toolbar-title>
                    <v-spacer />
                     <v-btn
                    text
              ...
              >
                <v-toolbar       
                  ...
                  >
                    <v-toolbar-title dense>
                      <v-icon class="title_font_color toolbar_icon_size">bar_chart</v-icon> 
                      <span class="toolbar_font_size">지역별 구매 건수</span>
                    </v-toolbar-title>
                    <v-spacer />
                     <v-btn
                    text
...
export default {
    ...
    methods : {
        ...
        makeChartData(){
           ...
           //차트 데이터를 생성한다.
            ...
            var countList = [];
             ...
             {
                  var str = this.TableList[i].IN_COUNTRY + '(' + this.TableList[i].CORPORATE_NAME +')';
                  labelList.push(str) ;
        ...
        searchProc(){
          //조회
          axios.post(`${CONST.HOST_ADDR}/BuyStatisticsCountry/selectBuyList_Country`, this.SearchCond).then(
            (ret)=>{
