...
@AuthCheck(MENU_ID=403, LEVEL = AuthLevel.READ)
@RestController
@RequestMapping("/BuyStatisticsCountry")
public class BuyStatisticsCountryController{
    ...
    //국가별 구매 이력을 가져온다.
    @RequestMapping("/selectBuyList_Country")
    public List<HashMap<String,Object>> selectBuyList_Country(@RequestBody HashMap<String, Object> searchCond)throws Exception{        
        return statisticsService.selectBuyList_Country(searchCond);
    }
